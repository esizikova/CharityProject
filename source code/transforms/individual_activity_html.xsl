...
<xsl:for-each select=".">
	...
	<div class="documents">
		<h4>Other formats</h4>
		<a href="/agg/activity/iati-identifier/{iati-identifier}/format/xml" target="_blank">XML</a> - 
		<a href="/agg/activity/iati-identifier/{iati-identifier}/format/json" target="_blank">JSON</a> - 
		<a href="http://tools.aidinfolabs.org/csv/direct_from_registry/?xml=http://www.iatiexplorer.org/agg/activity/iati-identifier/{iati-identifier}/format/xml"  target="_blank">CSV</a> (CSV Tool AidInfoLabs)
	</div>
